...
--
-- Host: localhost:3306
-- Waktu pembuatan: 28 Jun 2020 pada 09.59
...
--
-- Database: `awpshipc_ecertificate`
--
...
(2, 'super', '1b3231655cebb7a1f783eddf27d254ca', 1, 'ROBOT SUPER', 'l', '2.png', '0852 3334 1122', 'robot@mail.net', 'USA', NULL, 1, '2020-03-06 14:27:23'),
(14, 'admin', 'b78922ad971736f8f03ada535f5a6b22', 18, 'Administrator', 'l', '11203014.png', '0123 4567 8912', 'ec@gmail.com', 'Indonesia', NULL, 1, '2020-06-28 09:49:11');

-- --------------------------------------------------------

--
-- Struktur dari tabel `data_nilainonteknik`
--

CREATE TABLE `data_nilainonteknik` (
...
--
-- Dumping data untuk tabel `data_nilainonteknik`
--
...
--
-- Struktur dari tabel `data_nilaiteknik`
--

CREATE TABLE `data_nilaiteknik` (
  `id` int(10) UNSIGNED NOT NULL,
  `ids` varchar(10) DEFAULT NULL,
...
--
-- Dumping data untuk tabel `data_nilaiteknik`
--
...
--
-- Struktur dari tabel `temp_element`
--

CREATE TABLE `temp_element` (
...
--
-- Dumping data untuk tabel `temp_element`
--
...
--
-- Struktur dari tabel `temp_sertifikat`
--

CREATE TABLE `temp_sertifikat` (
...
--
-- Dumping data untuk tabel `tm_aspek`
--
...
--
-- Dumping data untuk tabel `tm_kelas`
--
...
--
-- Struktur dari tabel `tm_kompetensi_keahlian`
--

CREATE TABLE `tm_kompetensi_keahlian` (
  `id` int(10) UNSIGNED NOT NULL,
  `kode` varchar(5) DEFAULT NULL,
...
--
-- Dumping data untuk tabel `tm_kompetensi_keahlian`
--
...
--
-- Struktur dari tabel `tm_program_keahlian`
--

CREATE TABLE `tm_program_keahlian` (
  `id` int(10) UNSIGNED NOT NULL,
  `kode` varchar(5) DEFAULT NULL,
...
--
-- Dumping data untuk tabel `tm_program_keahlian`
--
...
--
-- Struktur dari tabel `tr_sebagai`
--

CREATE TABLE `tr_sebagai` (
  `id_sebagai` int(11) NOT NULL,
  `nama` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `tr_sebagai`
--
...
--
-- Indeks untuk tabel `data_nilainonteknik`
--
...
--
-- Indeks untuk tabel `data_nilaiteknik`
--
...
--
-- Indeks untuk tabel `temp_element`
--
ALTER TABLE `temp_element`
  ADD PRIMARY KEY (`id_element`);

--
-- Indeks untuk tabel `temp_sertifikat`
--
ALTER TABLE `temp_sertifikat`
  ADD PRIMARY KEY (`id_temp`);

--
-- Indeks untuk tabel `tm_aspek`
--
ALTER TABLE `tm_aspek`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `tm_kelas`
--
ALTER TABLE `tm_kelas`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `tm_kompetensi_keahlian`
--
ALTER TABLE `tm_kompetensi_keahlian`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `tm_program_keahlian`
--
ALTER TABLE `tm_program_keahlian`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `tr_sebagai`
--
...
--
ALTER TABLE `admin`
  MODIFY `id_admin` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=128;

--
-- AUTO_INCREMENT untuk tabel `data_nilainonteknik`
--
ALTER TABLE `data_nilainonteknik`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `data_nilaiteknik`
--
ALTER TABLE `data_nilaiteknik`
...
--
ALTER TABLE `main_log`
  MODIFY `id_log` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
...
--
-- AUTO_INCREMENT untuk tabel `temp_element`
--
ALTER TABLE `temp_element`
  MODIFY `id_element` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `temp_sertifikat`
--
ALTER TABLE `temp_sertifikat`
  MODIFY `id_temp` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT untuk tabel `tm_aspek`
--
ALTER TABLE `tm_aspek`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT untuk tabel `tm_kelas`
--
ALTER TABLE `tm_kelas`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `tm_kompetensi_keahlian`
--
ALTER TABLE `tm_kompetensi_keahlian`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `tm_program_keahlian`
--
ALTER TABLE `tm_program_keahlian`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `tr_sebagai`
--
ALTER TABLE `tr_sebagai`
